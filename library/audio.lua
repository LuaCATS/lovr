...
---@return userdata id The opaque id of the device.
...
---```
---
---@param blob Blob The Blob containing the Source data.
---@param options? {decode: boolean, pitchable: boolean, spatial: boolean, effects: table} Optional options.
---@return Source source The new Source.
function lovr.audio.newSource(blob, options) end
...
---```
---
---@param sound Sound The Sound containing raw audio samples to play.
---@param options? {decode: boolean, pitchable: boolean, spatial: boolean, effects: table} Optional options.
---@return Source source The new Source.
...
---@param sink? Sound An optional audio stream to use as a sink for the device.
...
---@param material? AudioMaterial The acoustic material to use.
...
---The triangles must use counterclockwise winding.
---
---@param model Model A model to use for the audio geometry.
---@param material? AudioMaterial The acoustic material to use.
---@return boolean success Whether audio geometry is supported by the current spatializer and the geometry was loaded successfully.
function lovr.audio.setGeometry(model, material) end
...
---Sets the orientation of the virtual audio listener in angle/axis representation.
---
---@param orientation Quat The orientation of the listener.
...
---The position of the listener doesn't use any specific units, but usually they can be thought of as meters to match the headset module.
---
---@param position Vec3 The position of the listener.
---@param orientation Quat The orientation of the listener.
...
---Sets the position of the virtual audio listener.  The position doesn't have any specific units, but usually they can be thought of as meters, to match the headset module.
---
---@param position Vec3 The listener position.
